...
namespace Koretech.Domains.KsApplications.BusinessObjects
{
	...
	/// </summary>
	public partial class KsControl : KsControlBase
	{
		...
		public static KsControl NewInstance(KsControlEntity entity)
		{
			KsControl businessObject = new(entity);
		...
		public static IList<KsControl> NewInstance(IList<KsControlEntity> entities)
		{
			List<KsControl> businessObjects = new();

			foreach (KsControlEntity entity in entities)
			{
				KsControl newBusinessObject = new(entity);
		...
		protected KsControl(KsControlEntity entity) : base(entity)
		{
			Initialize();
		}
	}
