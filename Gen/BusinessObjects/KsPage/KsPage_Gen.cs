...
namespace Koretech.Domains.KsPages.BusinessObjects
{
	...
	/// </summary>
	public partial class KsPage : KsPageBase
	{
		...
		public static KsPage NewInstance(KsPageEntity entity)
		{
			KsPage businessObject = new(entity);
		...
		public static IList<KsPage> NewInstance(IList<KsPageEntity> entities)
		{
			List<KsPage> businessObjects = new();

			foreach (KsPageEntity entity in entities)
			{
				KsPage newBusinessObject = new(entity);
		...
		protected KsPage(KsPageEntity entity) : base(entity)
		{
			Initialize();
		}
	}
