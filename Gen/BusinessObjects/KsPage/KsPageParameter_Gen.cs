...
namespace Koretech.Domains.KsPages.BusinessObjects
{
	...
	/// </summary>
	public partial class KsPageParameter : KsPageParameterBase
	{
		...
		public static KsPageParameter NewInstance(KsPageParameterEntity entity)
		{
			KsPageParameter businessObject = new(entity);
			...
			if (entity.KsPage != null)
			{
				businessObject.KsPage = BusinessObjects.KsPage.NewInstance(entity.KsPage);
			}
		...
		public static IList<KsPageParameter> NewInstance(IList<KsPageParameterEntity> entities)
		{
			List<KsPageParameter> businessObjects = new();

			foreach (KsPageParameterEntity entity in entities)
			{
				KsPageParameter newBusinessObject = new(entity);
				...
				if (entity.KsPage != null)
				{
					newBusinessObject.KsPage =  BusinessObjects.KsPage.NewInstance(entity.KsPage);
				}
			}
		...
		protected KsPageParameter(KsPageParameterEntity entity) : base(entity)
		{
			Initialize();
		}
	}
