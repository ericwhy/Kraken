...
namespace Koretech.Domains.KsPages.BusinessObjects
{
	...
	/// </summary>
	public partial class KsPageObject : KsPageObjectBase
	{
		...
		public static KsPageObject NewInstance(KsPageObjectEntity entity)
		{
			KsPageObject businessObject = new(entity);
		...
		public static IList<KsPageObject> NewInstance(IList<KsPageObjectEntity> entities)
		{
			List<KsPageObject> businessObjects = new();

			foreach (KsPageObjectEntity entity in entities)
			{
				KsPageObject newBusinessObject = new(entity);
		...
		protected KsPageObject(KsPageObjectEntity entity) : base(entity)
		{
			Initialize();
		}
	}
