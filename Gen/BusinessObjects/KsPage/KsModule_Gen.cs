...
namespace Koretech.Domains.KsPages.BusinessObjects
{
	...
	/// </summary>
	public partial class KsModule : KsModuleBase
	{
		...
		public static KsModule NewInstance(KsModuleEntity entity)
		{
			KsModule businessObject = new(entity);
		...
		public static IList<KsModule> NewInstance(IList<KsModuleEntity> entities)
		{
			List<KsModule> businessObjects = new();

			foreach (KsModuleEntity entity in entities)
			{
				KsModule newBusinessObject = new(entity);
		...
		protected KsModule(KsModuleEntity entity) : base(entity)
		{
			Initialize();
		}
	}
