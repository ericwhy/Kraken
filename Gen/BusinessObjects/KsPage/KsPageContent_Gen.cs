...
namespace Koretech.Domains.KsPages.BusinessObjects
{
	...
	/// </summary>
	public partial class KsPageContent : KsPageContentBase
	{
		...
		public static KsPageContent NewInstance(KsPageContentEntity entity)
		{
			KsPageContent businessObject = new(entity);
		...
		public static IList<KsPageContent> NewInstance(IList<KsPageContentEntity> entities)
		{
			List<KsPageContent> businessObjects = new();

			foreach (KsPageContentEntity entity in entities)
			{
				KsPageContent newBusinessObject = new(entity);
		...
		protected KsPageContent(KsPageContentEntity entity) : base(entity)
		{
			Initialize();
		}
	}
