...
namespace Koretech.Domains.KsMenus.BusinessObjects
{
	...
	/// </summary>
	public partial class KsMenu : KsMenuBase
	{
		...
		public static KsMenu NewInstance(KsMenuEntity entity)
		{
			KsMenu businessObject = new(entity);
		...
		public static IList<KsMenu> NewInstance(IList<KsMenuEntity> entities)
		{
			List<KsMenu> businessObjects = new();

			foreach (KsMenuEntity entity in entities)
			{
				KsMenu newBusinessObject = new(entity);
		...
		protected KsMenu(KsMenuEntity entity) : base(entity)
		{
			Initialize();
		}
	}
