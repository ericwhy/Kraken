...
namespace Koretech.Domains.KsMenus.BusinessObjects
{
	...
	/// </summary>
	public partial class KsMenuItem : KsMenuItemBase
	{
		...
		public static KsMenuItem NewInstance(KsMenuItemEntity entity)
		{
			KsMenuItem businessObject = new(entity);
		...
		public static IList<KsMenuItem> NewInstance(IList<KsMenuItemEntity> entities)
		{
			List<KsMenuItem> businessObjects = new();

			foreach (KsMenuItemEntity entity in entities)
			{
				KsMenuItem newBusinessObject = new(entity);
		...
		protected KsMenuItem(KsMenuItemEntity entity) : base(entity)
		{
			Initialize();
		}
	}
